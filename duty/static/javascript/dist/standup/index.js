...
var endpoint = '/standup/api/';
var membersEndpoint = '/members/api/members';
var Model = {
  members: [],
  chairman: null,
  ...
  fetch: function fetch() {
    state.fetching = true;
    return _mithril2.default.request({ url: endpoint, method: 'GET' }).then(function (response) {
  ...
  fetchMembers: function fetchMembers() {
    ...
    return _mithril2.default.request({ url: membersEndpoint, method: 'GET' }).then(function (response) {
...
},{"mithril":2}],0:[function(require,module,exports) {
var global = (1, eval)('this');
